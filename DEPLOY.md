...
PulpitOS is ready to deploy to Vercel.

## Required Secret

Create a fresh Anthropic API key and add it to Vercel as an environment variable:
...
5. In the Vercel project settings, add `ANTHROPIC_API_KEY` for Production and Preview.
6. Deploy.
