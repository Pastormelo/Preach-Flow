    ...
    updateActive({
      thread: [
        ...next,
        {
          role: "assistant",
          content:
            "I could not reach the coach server. Start the local server and set OPENAI_API_KEY to use coaching.",
        },
      ],
    });
  } finally {
...
async function reviewSermon() {
  ...
  try {
    ...
    ui.reviewResult =
      "I could not reach the review server. Start the local server and set OPENAI_API_KEY to use review.";
  } finally {
